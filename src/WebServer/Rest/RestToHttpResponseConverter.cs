    ...
    internal class RestToHttpResponseConverter
    {
        ...
        private HttpServerResponse GetDefaultContentResponse(IContentRestResponse response, RestServerRequest restReq)
        {
            ...
            if (response.ContentData != null)
            {
                ...
                defaultResponse.Content = _contentSerializer.ToAcceptContent(response.ContentData, restReq.AcceptMediaType, restReq.AcceptEncoding);
            }
        ...
        private HttpServerResponse GetDefaultContentResponse(InternalServerErrorResponse response, RestServerRequest restReq)
        {
            ...
            if (response.ContentData != null)
            {
                ...
                defaultResponse.Content = _contentSerializer.ToAcceptContent(errorMessage, restReq.AcceptMediaType, restReq.ContentEncoding);
            }
